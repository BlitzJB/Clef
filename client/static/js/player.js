...
export class Player {
    constructor(parent) {
        ...
        this.UI.play.addEventListener("click", () => this.resume());
    ...
    resume() {
        if (this.ispaused) {
            ...
            this.UI.play.innerHTML =
                '<div class="col fs-4 text-center align-self-center" id="play"><button class="btn btn-link btn-circle" style="border-radius: 50px;background: var(--secondary );border: .1px solid var(--primary);" type="button"><i class="fa fa-pause" style="color: var(--primary);font-size: 30px;margin-left: 0px;"></i></button></div>';
        } else {
            this.pause();
            this.UI.play.innerHTML =
                '<div class="col fs-4 text-center align-self-center" id="play"><button class="btn btn-link btn-circle" style="border-radius: 50px;background: var(--secondary );border: .1px solid var(--primary);" type="button"><i class="fa fa-play" style="color: var(--primary);font-size: 30px;margin-left: 6px;"></i></button></div>';
        }
    }
